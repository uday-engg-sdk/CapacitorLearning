...
* [`echo(...)`](#echo)
* [`addListener('ApplicationGoingToBackground', ...)`](#addlistenerapplicationgoingtobackground)
...
### addListener('ApplicationGoingToBackground', ...)

```typescript
addListener(eventName: 'ApplicationGoingToBackground', listenerFunc: CallBackListener) => Promise<PluginListenerHandle> & PluginListenerHandle
```

| Param              | Type                                                          |
| ------------------ | ------------------------------------------------------------- |
| **`eventName`**    | <code>'ApplicationGoingToBackground'</code>                   |
| **`listenerFunc`** | <code><a href="#callbacklistener">CallBackListener</a></code> |
...
| Prop       | Type                                      |
| ---------- | ----------------------------------------- |
| **`data`** | <code><a href="#string">String</a></code> |
...
<code>(event: <a href="#callbackdata">CallBackData</a>): void</code>
